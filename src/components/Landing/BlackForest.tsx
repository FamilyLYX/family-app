      ...
      <div className="xl:relative xl:h-screen md:flex md:flex-col justify-center p-2 m-2 xl:p-0 xl:m-0">
        <div className="xl:w-[50%] text-white text-center pt-10 xl:pt-4 mt-2">
          <p className="text-6xl xl:text-8xl xl:mb-14 mb-6 long-title">
            Honft - 001<span className="long-title block xl:inline xl:mx-8">Black Forest</span>
          </p>
        </div>
        ...
        <div className="xl:absolute xl:left-[50%] xl:right-0 xl:top-0 xl:h-screen  flex flex-col ">
          ...
          ></video>
            ...
            <CountdownTimerBlack />
            <button onClick={handleLogin} className="absolute bottom-4 left-0 right-0 w-full max-w-md  mx-auto  py-3 rounded-full font-medium text-white bg-black bg-opacity-25 hover:bg-opacity-50">
            127USD
          </button>
          </div>
