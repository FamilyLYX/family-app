...
function LeftActions() {
  return (
    <>
      <LinkButton variant="dark" to="/marketplace">
        Marketplace
      </LinkButton>
      <LinkButton variant="dark" to="/trade">
        Trade
      </LinkButton>
    </>
  );
    ...
    return (
      <>
        <Button onClick={() => connect()}>
          <span className="flex  justify-center gap-2 transition duration-700 invert hover:invert-0 ">
            <span className="">
              <svg
                width="20"
                height="20"
        ...
        <>
          <div className="mx-auto px-1 relative">
            <div className="flex items-center justify-between h-16">
              <img src={userIcon} className="block lg:hidden" />
