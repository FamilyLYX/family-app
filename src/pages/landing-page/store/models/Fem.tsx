  ...
  return (
    <group {...props} dispose={null}>
      <group rotation={[Math.PI / 2, 0, 0]}>
        <mesh
          geometry={nodes.fem_1.geometry}
          material={materials.Base_texture_FRONT_2299}
        />
        <mesh
          geometry={nodes.fem_2.geometry}
          material={materials.Laces_FRONT_2287}
        />
        <mesh
          geometry={nodes.fem_3.geometry}
          material={materials.Laces_FRONT_2287}
        />
        <mesh
          geometry={nodes.fem_4.geometry}
          material={materials.pants_FRONT_131240}
        />
