import { abi } from "family-contracts/artifacts/contracts/AssetRegistry.sol/AssetRegistry.json";
...
export function useAssetRegistry() {
  ...
  async function getCollection(uid: string) {
    ...
    const [collection, tokenId] = await registry.getFunction('checkIdentifier')(identifier);
