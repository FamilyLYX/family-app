        ...
        <div className="flex flex-col space-y-4">
                ...
                !next && !buy && (
                    <>
                        <div className="flex flex-row justify-between">
                            <p className="long-title text-8xl ">Buy <span className="long-title text-8xl text-gray-400 xl:inline">Honft</span></p>
                            <svg width="40" height="40" viewBox="0 0 40 40" onClick={() => {window.location.href="/landing"}} fill="none" xmlns="http://www.w3.org/2000/svg">
                            
                                <rect x="0.5" y="0.5" width="39" height="39" rx="19.5" stroke="black" stroke-opacity="0.07"/>
                            
                                <path d="M25 15L15 25M15 15L25 25" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
                        <AddressForm update={setAddress} />
                        <Button variant="dark" onClick={() => {setNext(true)}} >Next</Button>
                    </>
                )
            }
                ...
                next && !buy && (
                    <>
                        <div className="flex flex-row justify-start space-x-8" >
                            <svg width="40" height="40" viewBox="0 0 40 40" onClick={() => {setNext(false)}} fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0.5" y="0.5" width="39" height="39" rx="19.5" stroke="black" stroke-opacity="0.07"/>
                                <path d="M25.8334 20H14.1667M14.1667 20L20.0001 25.8334M14.1667 20L20.0001 14.1667" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
            ...
            {/* Payment method screen Mobile */}
            {
                buy && (
                    <>
                        <div className="flex flex-row justify-between">
                            <svg width="40" height="40" viewBox="0 0 40 40" onClick={() => {setBuy(false); setNext(true)}} fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0.5" y="0.5" width="39" height="39" rx="19.5" stroke="black" stroke-opacity="0.07"/>
                                <path d="M25.8334 20H14.1667M14.1667 20L20.0001 25.8334M14.1667 20L20.0001 14.1667" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        ...
                        <div className="space-y-2 flex flex-col min-h-screen justify-center items-center ">
                            <h2 className="text-2xl pl-4 font-medium leading-6 text-gray-900 text-center" >Choose Payment Method</h2>
